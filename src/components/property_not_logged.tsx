...
interface PropertyNotLoggedProgs {
  offers: Offer[];
}

function PropertyNotLogged({offers}: PropertyNotLoggedProgs): JSX.Element {
          ...
          <div className="property__gallery-container container">
            <div className="property__gallery">
              <div className="property__image-wrapper">
                <img className="property__image" src={offer.imgUrl} alt={offer.name}/>
              </div>
              <div className="property__image-wrapper">
          ...
          <div className="property__container container">
            <div className="property__wrapper">
              ...
              <div className="property__name-wrapper">
                ...
                <button className={`property__bookmark-button button ${offer.isBookmarks ? 'property__bookmark-button--active' : ''}`} type="button">
              ...
              <div className="property__price">
                ...
                <span className="property__price-text">&nbsp;{offer.dayOrNight}</span>
              </div>
